...
Совместимость:
  ...
  Inventory Balance требует, чтобы ванильный лут с трупов NPC был включён. Отключите любой мод, блокирующий лутание (например "NPC Stop Looting Dead Bodies") для полного эффекта.
